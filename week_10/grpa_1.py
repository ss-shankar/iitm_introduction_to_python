...
Methods
    (1) __init__: accept two arguments a and b, assign them to the
corresponding attributes
    (2) add: return the sum of the two attributes
    (3) multiply: return the product of the two attributes
    (4) subtract: subtract the second attribute from the first and return this
value
    (5) quotient: return the quotient when the first attribute is divided by
the second attribute
    (6) remainder: return the remainder when the first attribute is divided by
the second
"""
