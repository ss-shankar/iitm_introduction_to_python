...
additional arguments, if any.
    (1) __init__: constructor with two arguments — name and marks;
assign these two values to the corresponding attributes within the constructor
    (2) print_info: prints the name and the marks of the student separated by a
colon.
"""
